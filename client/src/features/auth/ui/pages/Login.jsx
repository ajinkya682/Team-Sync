...
const Login = () => {
  ...
  // Base style configurations for pristine inputs
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans text-slate-900 selection:bg-indigo-100">
      <div className="w-full max-w-6xl grid md:grid-cols-12 bg-white md:rounded-2xl md:shadow-xl md:border md:border-slate-100 overflow-hidden min-h-[90vh] md:min-h-[680px] md:m-4">
        ...
        <div className="hidden md:flex md:col-span-5 bg-gradient-to-br from-indigo-900 to-slate-900 p-12 flex-col justify-between relative overflow-hidden">
          {/* Subtle abstract background graphic matching register page */}
          ...
          <div className="relative z-10 mb-8">
            <h1 className="text-3xl font-semibold text-white tracking-tight leading-tight mb-4">
              Sign in to continue to your collaborative data workspace.
            </h1>
            <p className="text-slate-300 text-sm leading-relaxed">
              Access your centralized dashboards, shared data catalogs, and
              secure intelligence assets right where you left off.
            </p>
          </div>
        ...
        <div className="col-span-12 md:col-span-7 flex flex-col justify-center p-6 sm:p-12 lg:p-16 bg-white">
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 context-none select-none transition-colors"
                  >
                    {showPassword ? (
                      <svg
                        className="h-4 w-4"
              ...
              <div className="pt-1">
                <label className="flex items-center gap-3 cursor-pointer group selection:bg-transparent">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500/20 transition-colors cursor-pointer"
                    {...register("rememberMe")}
                  />
